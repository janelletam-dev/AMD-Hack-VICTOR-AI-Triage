...
export default function ClinicianDashboard() {
  ...
  const processEvent = useCallback((type, data, ts) => {
    if (type === "transcript") {
      ...
      // verbatim accordion can replay the full Q&A flow. Skip empty / non-
      // final lines and dedupe consecutive identical text (Deepgram
      // occasionally re-emits the same final on phase boundaries).
